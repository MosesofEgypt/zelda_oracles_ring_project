...
AGES_REPLACE_MAP = dict(
    ...
    W_LINK_FORCE_STATE      = b'\x4f\xcc', # wLinkForceState
    ...
    W_INVENTORY_B_L         = b'\x88',     # wInventoryB
    W_INVENTORY_A_L         = b'\x89',     # wInventoryA
    ...
    ITEM_DELETE_PARENT      = b'\x33',     # @deleteParent
    PARENT_ITEM_CHECK_AB    = b'\x0f',     # @parentItem.checkAB
    UPDATE_PARENT_ITEMS     = b'\x19',     # @parentItem.updateParentItems
...
SEAS_REPLACE_MAP = dict(
    ...
    W_LINK_FORCE_STATE      = b'\x6a\xcc', # wLinkForceState
    ...
    W_INVENTORY_B_L         = b'\x80',     # wInventoryB
    W_INVENTORY_A_L         = b'\x81',     # wInventoryA
    ...
    ITEM_DELETE_PARENT      = b'\x3c',     # @deleteParent
    PARENT_ITEM_CHECK_AB    = b'\x08',     # @parentItem.checkAB
    UPDATE_PARENT_ITEMS     = b'\x12',     # @parentItem.updateParentItems
